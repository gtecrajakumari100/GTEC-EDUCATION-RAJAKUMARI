 ...
 * Handles Navbar scroll transformation, mobile menu drawer, courses dropdown,
 * active neon line & lightbox.
 */
...
function setActiveNavLink() {
  ...
  navLinks.forEach((link) => {
    ...
    if (
      ...
      (courseSubpages.includes(currentPath) &&
        hrefBase === "courses.html")
    ) {
